...
def upstreamProjects = [
  ...
  // Direct
  'model', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-dia-model</artifactId>
  'servlet', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-dia-servlet</artifactId>
  'taglib', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-dia-taglib</artifactId>

  // Runtime Direct
  'renderer-html', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-dia-renderer-html</artifactId>
  'style', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-dia-style</artifactId>
  'view', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-dia-view</artifactId>
